...
export default function NotesList({ notes, loading, currentNoteId, onNoteClick }: NotesListProps) {
  if (loading) {
    return (
  ...
  if (notes.length === 0) {
    return (
      <div className="text-center py-12">
        ...
        <p className="text-gray-500 text-sm">¡Crea tu primera idea para empezar!</p>
      </div>
    );
  }
